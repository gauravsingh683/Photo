...
new_frames = '''
    { 
      id: 'collage_strip3_love', name: 'Sweetheart (3)', layout: 'strip3', side: 'right', style: { border: '25px solid #ffe4e1', borderBottomWidth: '80px', backgroundColor: '#ffe4e1' }, imageStyle: { top: '0', bottom: '0', left: '0', right: '0', backgroundColor: '#ffe4e1' },
      overlay: (
...
new_content = re.sub(r'(id: \'collage_grid4_editorial\'.*?\},)', r'\1\n' + new_frames, content, flags=re.DOTALL)
