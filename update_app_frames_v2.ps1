  ...
  const FrameMagazine = () => (
    <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', border: '15px solid white', boxSizing: 'border-box', zIndex: 5, display: 'flex', flexDirection: 'column' }}>
       <div style={{ width: '100%', textAlign: 'center', paddingTop: '20px' }}>
         <h1 style={{ fontFamily: 'Times New Roman, serif', fontSize: '80px', margin: 0, color: 'rgba(255,255,255,0.9)', textShadow: '0 5px 15px rgba(0,0,0,0.8)', letterSpacing: '8px', fontWeight: 'normal' }}>VOGUE</h1>
       </div>
       <div style={{ flexGrow: 1, position: 'relative' }}>
          <div style={{ position: 'absolute', left: '20px', bottom: '40px', color: 'white', textShadow: '0 2px 10px rgba(0,0,0,0.8)', maxWidth: '150px' }}>
          ...
          <div style={{ position: 'absolute', right: '20px', top: '40px', color: 'white', textShadow: '0 2px 10px rgba(0,0,0,0.8)', maxWidth: '150px', textAlign: 'right' }}>
